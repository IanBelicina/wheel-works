...
urlpatterns  =[
 ...
 path("appointments/history/", api_history_appointments, name="api_history_appointments"),
path("appointments/history/", api_history_appointments, name="api_history_appointments"),
path("automobiles/", api_automobile_lists, name="api_automobile_lists"),
